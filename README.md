...
$${\space}$$
Digite el nombre de usuario o username o usuario e oprima $${color{green}'Enter'\space}$$ en el caso de haber ingresado con el email o correo electrónico, y si ingreso con el nombre de usuario o username o usuario digite el email o correo electrónico e oprima 'Enter'
